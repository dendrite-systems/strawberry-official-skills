...
description: Keep your CRM in sync without logging anything manually.
---

# Keep my CRM updated from my emails

## Starting intent

Help me keep my CRM up to date without manual logging. If you don't already know, ask me which CRM I use and which email account to monitor. Then set up a Routine to monitor my emails and update the records automatically.
...
Keep your CRM in sync without logging anything manually.
