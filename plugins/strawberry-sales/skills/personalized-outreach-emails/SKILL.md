...
description: Draft a tailored cold email for every contact on your list.
---

# Write personalised outreach emails for my prospect list

## Starting intent

Help me write personalised outreach emails for a prospect list. Ask me where the list is: a Google Sheet, Notion doc, or paste it here. You might want to check what you already know about my product and ICP before drafting. Then research each company briefly and write a tailored email for each contact based on their background and company context.
...
Draft a tailored cold email for every contact on your list.
