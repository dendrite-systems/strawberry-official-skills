---
name: extract-google-business-data
description: Pull calls, clicks, and performance data from all your Google Business profiles.
---

# Extract performance data from multiple Google Business profiles

## Starting intent

Help me pull data from my Google Business profiles. You might want to check how many profiles are connected to my account first. Then ask me which metrics I need and extract the data across all profiles into a single sheet.
...
Pull calls, clicks, and performance data from all your Google Business profiles.
