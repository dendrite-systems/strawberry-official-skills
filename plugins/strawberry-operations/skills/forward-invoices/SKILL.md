...
description: Set up automatic invoice forwarding so nothing gets missed.
---

# Forward invoices from my inbox to my bookkeeper

## Starting intent

Help me automate invoice processing. If you don't already know, ask me where invoices come in and who my bookkeeper is. Then set up a Routine so receipts and invoices get forwarded automatically.
...
Set up automatic invoice forwarding so nothing gets missed.
