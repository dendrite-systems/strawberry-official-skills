---
name: audit-strawberry-capabilities
description: Find out exactly where Strawberry can save you the most time.
---

# Audit what Strawberry can do for my company

## Starting intent

Run an audit of how I could use Strawberry across my workflow. You might want to start by mapping what you already know about my role, tools, and day-to-day tasks. Then match each area against what Strawberry can automate and give me a prioritised list of where to start.
...
Find out exactly where Strawberry can save you the most time.
