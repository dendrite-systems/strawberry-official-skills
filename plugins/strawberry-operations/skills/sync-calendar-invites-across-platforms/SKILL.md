---
name: sync-calendar-invites-across-platforms
description: Pull meeting invites from one calendar into another so nothing falls through the cracks.
---

# Sync calendar invites across platforms

## Starting intent

Help me sync my calendar invites across platforms. If you don't already know, ask me which accounts to connect. Then set up a Routine that automatically copies new meeting invites across, including all details like agenda, attendees, and location.
...
Pull meeting invites from one calendar into another so nothing falls through the cracks.
