---
name: summarise-customer-notes
description: Turn scattered customer notes into a clean summary with next steps.
---

# Summarise my customer notes and list next steps

## Starting intent

Help me process my customer notes. Ask me where they are: a Notion page, a Google Doc, or paste them here. Then summarise what was discussed and pull out the next steps for each one.
...
Turn scattered customer notes into a clean summary with next steps.
