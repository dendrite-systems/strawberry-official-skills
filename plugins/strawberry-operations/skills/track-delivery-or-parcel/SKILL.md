---
name: track-delivery-or-parcel
description: Get a live status update on any parcel by giving your companion the tracking number.
---

# Track a delivery or parcel

## Starting intent

Help me track a delivery. Ask me for the tracking number and carrier if you don't already have it. Then check the current status and give me a clear update on where it is and when it is expected to arrive.
...
Get a live status update on any parcel by giving your companion the tracking number.
