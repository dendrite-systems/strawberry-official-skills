---
name: catch-up-slack
description: Get a digest of everything unread across all your Slack channels.
---

# Catch me up on all unread Slack messages

## Starting intent

Help me catch up on Slack. You might want to go through everything unread across all my channels and figure out what needs my attention. If you need to know the time period to focus on, ask. Then give me a clean digest grouped by topic or urgency.
...
Get a digest of everything unread across all your Slack channels.
