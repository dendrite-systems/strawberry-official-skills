---
name: bulk-delete-old-unread-emails
description: Clear out hundreds of old unread emails automatically so your inbox is clean again.
---

# Bulk delete old unread emails

## Starting intent

Help me clean up my inbox by deleting old unread emails. If you don't already know, ask me which email account to use and how far back to go. Then delete them in large batches automatically without asking me to approve each one.
...
Clear out hundreds of old unread emails automatically so your inbox is clean again.
