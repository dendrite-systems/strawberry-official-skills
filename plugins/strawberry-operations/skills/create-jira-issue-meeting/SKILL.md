---
name: create-jira-issue-meeting
description: Turn meeting notes into a tracked Jira ticket and update your project log automatically.
---

# Create a Jira issue from a meeting

## Starting intent

Help me create a Jira issue from a meeting. Ask me what the meeting was about and what needs to be tracked. You might want to look at any notes I can share. Then create the issue with the right title, description, and labels, and log it in the relevant project.
