---
name: auto-label-file-emails
description: Keep your inbox organised without touching it yourself.
---

# Automatically label and file incoming emails

## Starting intent

Set up an automatic email filing routine. If you don't already know my email account and filing preferences, ask. Then set up a Routine that reads each incoming email and applies the right label and files it in the correct folder automatically.
...
Keep your inbox organised without touching it yourself.
