...
description: Pull context from your tools and build workshop materials in one go.
---

# Prepare a workshop using my connected tools

## Starting intent

Help me prepare for a team workshop. Ask me what it's about. You might want to check which tools the team uses from what you know about our stack. Then pull relevant context from Slack, Notion, email, and other connected sources to build the agenda and materials.
...
Pull context from your tools and build workshop materials in one go.
