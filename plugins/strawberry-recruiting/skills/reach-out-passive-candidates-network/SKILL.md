---
name: reach-out-passive-candidates-network
description: Find people in your network who match a role and draft outreach for each.
---

# Reach out to passive candidates in your network

## Starting intent

Help me find and approach passive candidates for a role. Ask me about the job description. You might want to start by searching my LinkedIn connections for people who match the profile. Then draft a personalised message for each one and ask me to review before sending.
...
Find people in your network who match a role and draft outreach for each.
