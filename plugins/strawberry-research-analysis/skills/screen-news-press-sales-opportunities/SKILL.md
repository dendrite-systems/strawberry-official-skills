---
name: screen-news-press-sales-opportunities
description: Monitor business press for mentions of projects, expansions, or pain points in target sectors.
---

# Screen news and press for sales opportunities

## Starting intent

Help me screen the news for sales opportunities in my target market. Ask me which industries, regions, and signal types to look for. You might want to set this up as a recurring Routine so you catch new coverage as it happens. Then surface the most relevant stories with a short note on why each one is worth acting on.
...
Monitor business press for mentions of projects, expansions, or pain points in target sectors.
