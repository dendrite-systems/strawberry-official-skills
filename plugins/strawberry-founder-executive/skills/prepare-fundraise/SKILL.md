...
If the founder's writing style is not already clear, use `strawberry/learn-writing-style` with
approved examples.
...
3. Create only the materials needed for the accepted first run. These may include a fundraising
   ...
   tracker. Use `strawberry/create-beautiful-slide-deck` for a finished deck rather than duplicating
...
2. Use `strawberry/map-key-players-industry-or-ecosystem` for the detailed sourcing, evidence, and
...
`strawberry/personalized-outreach-sequence`; keep its verification, drafting, and sending rules
there. Use `strawberry/prepare-for-calls` for scheduled investor conversations. Drafting does not
