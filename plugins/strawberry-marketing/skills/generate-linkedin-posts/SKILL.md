...
description: Turn a brief into three LinkedIn posts in different styles.
---

# Generate LinkedIn posts from a content brief

## Starting intent

I want to write a LinkedIn post. Ask me what I want to say. You might want to check my previous posts first to match my style. Write 3 versions: one punchy, one storytelling, one data-led.
...
Turn a brief into three LinkedIn posts in different styles.
