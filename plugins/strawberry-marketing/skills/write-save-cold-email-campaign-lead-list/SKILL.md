---
name: write-save-cold-email-campaign-lead-list
description: Turn a lead list into personalised draft emails ready to send.
---

# Write and save a cold email campaign from your lead list

## Starting intent

Help me run an email campaign. You might want to pull my lead list from Google Sheets. Then research each company, write a personalised email for each contact, and save them as drafts in my email inbox ready for me to review and send.
...
Turn a lead list into personalised draft emails ready to send.
