---
name: analyse-social-media-performance-suggest-next-steps
description: Pull engagement data from your social channels and turn it into a concrete action plan.
---

# Analyse my social media performance and suggest next steps

## Starting intent

Help me analyse my social media performance. Ask me which platforms and time period to look at. Then pull the data, identify what is working and what is not, and give me three to five concrete things to change or try next.
...
Pull engagement data from your social channels and turn it into a concrete action plan.
