---
name: set-up-weekly-industry-briefing
description: Get a recurring digest of the key news, moves, and conversations in your industry every week.
---

# Set up a weekly industry briefing

## Starting intent

Help me set up a weekly industry briefing. Ask me which topics, companies, and sources matter most. Then set up a Routine that runs every week, pulls the most important updates, and sends me a digest with the key stories and what they mean for my work.
...
Get a recurring digest of the key news, moves, and conversations in your industry every week.
