...
- If the user needs new accounts or prospects before enrichment, use `strawberry/sales/source-customers`.
- If the user wants to contact approved leads, use `strawberry/sales/personalized-outreach-sequence`.
